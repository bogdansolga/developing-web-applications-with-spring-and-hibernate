...
import net.safedata.spring.training.exception.handling.dto.MessageDTO;
...
public class ExceptionHandlers {
    ...
    public MessageDTO internalServerError(final Exception e) {
        ...
        return new MessageDTO("A team of highly qualified monkeys has been dispatched to solve the issue :)");
    }
}
